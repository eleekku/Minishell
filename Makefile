...
parse_dolar.c signals.c minishell_utils.c token_redirec.c token_dolar.c token_str.c termios_signals.c iter_token_utils.c parse_cmd_utils.c make_recd_str.c
